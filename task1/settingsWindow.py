...
class SettingsWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.coef_path_radio_default.setChecked(True)
        ...
        self.temp_path_radio_default.setChecked(True)
        ...
        self.time_path_radio_default.setChecked(True)
        ...
        self.outp_path_radio_default.setChecked(True)
